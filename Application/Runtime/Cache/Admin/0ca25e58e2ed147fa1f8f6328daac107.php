                     ...
                     <form id="form" class="form-horizontal" role="form">
                              <input type="hidden" name="id" value="<?php echo ($goods['id']); ?>">
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input class="form-control" type="text" name="name" value="<?php echo ($goods['goods_name']); ?>">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <select class="form-control" name="cid">
                                      ...
                                      <?php if(is_array($toList)): $i = 0; $__LIST__ = $toList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cate['cate_id']); ?>" <?php if($cate['cate_id']==$goods['cate_id']): ?>selected="selected"<?php endif; ?>><?php if($cate['path']==2): ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php endif; echo ($cate['cate_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>                               
                                    </select>
                                  </div>
                                </div>    
                                 <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                     <input class="form-control" placeholder="请输入商品价格" type="text" name="price" value="<?php echo ($goods['goods_price']); ?>">
                                  </div>
                                </div>  
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input class="form-control" placeholder="请输入商品库存" type="text" name="store" value="<?php echo ($goods['goods_store']); ?>">
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="col-lg-2 text-right">
                                     <img src="/0714/Uploads/<?php echo ($goods['goods_thumb']); ?>" width="80" id="image">
                                   </div>   								
                                </div>
                                ...
                                <div class="form-group">
                                	  ...
                                	  <div class="col-lg-8">	 
                                	     <script id="editor" type="text/plain" name="desc" style="width:100%;height:200px;">
...
<script type="text/javascript">
  ...
  $('#formSubmit').bind('click', function() {
      ...
      $.ajax({
        url:'/0714/admin.php/Goods/updateDoit',
        data:data,
        type:'post',
