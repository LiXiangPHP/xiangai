...
<link rel="stylesheet" href="/0714/Public/Home/css/public_efb6e35.css">
<link rel="stylesheet" href="/0714/Public/Home/css/brandindex_76b0223.css">
...
<script src="/0714/Public/Home/js/jquery_2a410e3.js"></script>
<script src="/0714/Public/Home/js/fixcore.js"></script>
<script src="/0714/Public/Home/js/lab.min_e842152.js"></script>
<script src="/0714/Public/Home/js/sea_7e06016.js"></script>
...
<header id="jcZAHeader" class="header za-brand-header">
    <section class="frameW top-bar clearfix"> <a class="logo" href="#" title="相爱网"><img src="/0714/Public/Home/images/picture/logo.png" width="100%"/></a>
            ...
            <form id="loginForm" name="form1" action="http://profile.zhenai.com/login/loginactionindex.jsps?from=newmain" method="post">
                ...
                <div class="login-form">
                    <div class="login-items">
                        <input id="jcLoginName" class="login-in" type="text" value="QQ/手机" name="loginInfo">
                        <br>
                        <span class="error-tips">用户名不能为空</span> </div>
                    <div class="login-items">
                        <input id="jcLoginPass" class="login-in" type="password" name="password">
                        <br>
                        <div class="lgin-next">
                            <input type="checkbox" name="autoLogin" id="nextLogin">
                            <label for="nextLogin">下次自动登录</label>
                        </div>
                        <a href="http://register.zhenai.com/login/findPasswordNav.jsps" class="forget" rel="nofollow">忘记密码？</a> <span class="pass-txt">密码</span> </div>
                    <a href="javascript:;" class="btnP2 login-btn">登录</a> <a class="login-by-qq" href="http://connect.zhenai.com/qq/login.x?fromurl=" title="QQ号登录"  target="_blank" rel="nofollow"></a> <a class="login-by-weibo" href="http://static.zhenai.com/weibo/login.jsps?fromurl=" title="微博号登录"  target="_blank" rel="nofollow"></a> </div>
            </form>
        </div>
    </section>
</header>
<article class="za-brand-wraper">
    <section class="banner">
        <div id="jcBrandBanner" class="banner-container">
            <ul class="slide-content">
                <li class="ban cur"> <img src="/0714/Public/Home/images/picture/1be94dcfa44fe471.jpg" width="100%" height="100%" />
                    <div id="jcBanner" class="frameW"></div>
                </li>
                <li class="ban cur"> <img src="/0714/Public/Home/images/picture/109b7306a46037d6.jpg" width="100%" height="100%" />
                    <div id="jcBanner" class="frameW"></div>
                </li>
                <li class="ban cur"> <img src="/0714/Public/Home/images/picture/942b373f6ead1378.jpg" width="100%" height="100%" />
                    <div id="jcBanner" class="frameW"></div>
                </li>
            </ul>
            <div class="frameW">
    ...
    <section class="brand-service">
        <div class="frameW">
            ...
            <ul id="jcBrandService" class="clearfix">
                <li>
                    <div class="pic"><img src="/0714/Public/Home/images/picture/service1_43a6b5c.jpg" alt=""></div>
                </li>
                <li>
                    <div class="pic"><img src="/0714/Public/Home/images/picture/service2_3de8eb4.jpg" alt=""></div>
                </li>
                <li>
                    <div class="pic"><img src="/0714/Public/Home/images/picture/service3_d6314d8.jpg" alt=""></div>
                </li>
                <li>
                    <div class="pic"><img src="/0714/Public/Home/images/picture/service4_d928265.jpg" alt=""></div>
                </li>
            </ul>
        </div>
    </section>
        ...
        <div class="frameW">
            ...
            <div class="cooperation-ad clearfix">
                <div id="jcCoopBanner" class="adImg sroll-container">
                    <ul>
                        <li class="cur"> <a id="jcCoopBannera" href="http://profile.zhenai.com/payment/index.jsps" onclick="stat(1633,1,0,0)" target="_blank"> <img id="jcCoopBannerImg" src="/0714/Public/Home/images/picture/a1_e19aa08.jpg" alt=""> </a> </li>
                    </ul>
                ...
                <div class="adImg"><img src="/0714/Public/Home/images/picture/1469069397480.jpg" /> <a href="" class="mask" target="_blank" onclick="stat(1633,5,0,0)" rel="nofollow"></a> </div>
                <div class="adImg"><img src="/0714/Public/Home/images/picture/b3.jpg"/><a href="" class="mask" target="_blank" onclick="stat(1633,3,0,0)" rel="nofollow"></a> </div>
    ...
    <section id="jcBrandLead" class="brand-lead">
        <div class="frameW">
            ...
            <div class="action"> <a class="btn-reg" href="javascript:;">注册</a> <a class="btn-login" href="javascript:;">登录</a> </div>
        </div>
    </section>
</article>
<script type="text/javascript">
...
$LAB.script("/0714/Public/Home/js/jquery_2a410e3.js").wait()
    .wait(function(){
        //统计新版首页PV
        stat(1633,9,0,0);
...
<script type="text/javascript" id="zp_script_65" src="/0714/Public/Home/js/p.js" zp_type="1"></script>
</body>
</html>