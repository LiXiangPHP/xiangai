    ...
    <section class="banner">
        <div id="jcBrandBanner" class="banner-container">
            <ul class="slide-content">
                <li class="ban cur"> <img src="/111/xiangai/Public/Home/images/picture/1be94dcfa44fe471.jpg" width="100%" height="100%" />
                    <div id="jcBanner" class="frameW"></div>
                </li>
                <li class="ban cur"> <img src="/111/xiangai/Public/Home/images/picture/109b7306a46037d6.jpg" width="100%" height="100%" />
                    <div id="jcBanner" class="frameW"></div>
                </li>
                <li class="ban cur"> <img src="/111/xiangai/Public/Home/images/picture/942b373f6ead1378.jpg" width="100%" height="100%" />
                    <div id="jcBanner" class="frameW"></div>
                </li>
            </ul>
            <div class="frameW">
