								...
								<div class="widget">
									...
									<div class="widget-content">
										<table class="table table-striped table-bordered table-hover">
											...
											<tbody>
                                                <?php if(is_array($cateList)): $i = 0; $__LIST__ = $cateList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><tr cid="<?php echo ($cate['cate_id']); ?>" pid="<?php echo ($cate['parent_id']); ?>" style='display:<?php if($cate['path'] > 1): ?>none;<?php endif; ?>'>	
