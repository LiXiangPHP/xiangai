...
<html lang="en"><head>
	...
	<div class="mainbar">
				<!-- Page heading -->
				<div class="page-head">
					<h2 class="pull-left"><i class="icon-list-alt"></i>编辑商品</h2>

					<!-- Breadcrumb -->
					<div class="bread-crumb pull-right">
						<a href="<?php echo U('lists');?>"><i class="icon-list-alt"></i>分类列表</a>
						<!-- Divider -->
						<span class="divider">/</span>
						<a href="<?php echo U('insert');?>" class="bread-current">编辑商品</a>
					</div>
                  ...
                  <div class="padd">            
                    <!-- Form starts.  -->
                     <form id="form" class="form-horizontal" role="form">
							<input type="hidden" name="cate_id" value="<?php echo ($cates['cate_id']); ?>">
                               
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">分类名称</label>
                                  <div class="col-lg-8">
                                    <input class="form-control" type="text" name="cate_name" value="<?php echo ($cates['cate_name']); ?>">
                                    <p class="help-block" style="color: #EC4844;"></p>
                                  </div>
                                </div>
                                                                                                                                                 
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">商品父分类</label>
                                  <div class="col-lg-8">
                                    <select class="form-control" name="parent_id" >
                                      <option value="0">请选择分类</option>
                                      <?php if(is_array($cateList)): $i = 0; $__LIST__ = $cateList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><option  value="<?php echo ($cate['cate_id']); ?>" <?php if($cate['cate_id']==$cates['parent_id']): ?>selected="selected"<?php endif; ?>><?php if($cate['path']==2): ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php endif; echo ($cate['cate_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>                               
                                    </select>
                                  </div>
                                </div>    
                                 <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                     <input class="form-control" placeholder="请输入商品价格" type="text" name="sort_order" value="<?php echo ($cate['sort_order']); ?>">
                                  </div>
                                </div>  
                                
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">是否删除</label>
                                  <div class="col-lg-6 checkbox" style="margin-left:20px;" >
									 <label><input  type="checkbox" name="is_delete" value="<?php echo ($cates['is_delete']); ?>">删除</label>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                	  <label class="col-lg-4 control-label">分类关键字</label>
                                	  <div class="col-lg-8">	 
                                	     <textarea class="form-control"  width="100%" name="keywords" value="<?php echo ($cate['keywords']); ?>"></textarea>
                                	  </div>   								
                                </div>
								
                                <div class="form-group">
                                	  <label class="col-lg-4 control-label">分类描述</label>
                                	  <div class="col-lg-8">	 
                                	     <textarea class="form-control" width="100%" name="cate_desc" value="<?php echo ($cate['cate_desc']); ?>"></textarea>
                                	  </div>   								
                                </div>
                                ...
                                <div class="form-group">
                                  <div class="col-lg-offset-1 col-lg-9">
                                    ...
                                    <button type="button" class="btn btn-primary" id="formSubmit">保存编辑</button>
