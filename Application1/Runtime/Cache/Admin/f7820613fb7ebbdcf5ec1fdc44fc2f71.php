                     ...
                     <form id="form" class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <select class="form-control" name="parent_id">
                                      ...
                                      <?php if(is_array($cateList)): $i = 0; $__LIST__ = $cateList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cate['cate_id']); ?>"><?php if($cate['path']==2): ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php endif; echo ($cate['cate_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>                               
                                    </select>
                                  </div>
                                </div>    
                                 <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                     <input class="form-control" placeholder="请输入商品价格" type="text" name="sort_order">
                                  </div>
                                </div>  
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-6 checkbox" style="margin-left:20px;" >
									 <label><input  type="checkbox" name="is_delete">删除</label>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                	  ...
                                	  <div class="col-lg-8">	 
                                	     <textarea class="form-control"  width="100%" name="keywords"></textarea>
                                	  </div>   								
                                </div>
                                ...
                                <div class="form-group">
                                	  ...
                                	  <div class="col-lg-8">	 
                                	     <textarea class="form-control" width="100%" name="cate_desc"></textarea>
                                	  </div>   								
                                </div>
...
<script type="text/javascript">
  ...
  $('#formSubmit').bind('click', function() {
      ...
      $.ajax({
        url:'/0708/admin.php/Category/insertDoit',
        data:data,
        type:'post',
